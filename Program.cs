...
{ 
    ...
    if (FRONT == -1)
    {
        ...
        {
        /* If REAR is at the last position of the array, then the value P
        of
        ...
        { 
            ...
            else
            {
                ...
                while (FRONT_position <= REAR position)
                { 
                Console.Write(queue_array[FRONT_position] +
                FRONT_position++;
                }
            ...
            static void Main(string[] args)
    {
            ...
            while (true)
            {
                try
                {
                    ...
                    Console.WriteLine("2. Implement delete operation"); Console.WriteLine("3. Display values");
